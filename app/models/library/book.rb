...
class Library::Book < Library::Citation
  #attr_accessible :author, :year, :title, :editor, :city, :publisher_id, :volume, :pages, :edition, :isbn_or_issn, :doi, :keywords, :abstract, :url

  

  def self.custom_attributes
    [ :author, :year, :title, :editor, :city, :publisher_id, :volume, :pages, :edition, :isbn_or_issn, :doi, :keywords, :abstract, :url]
  end
end
