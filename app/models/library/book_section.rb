...
class Library::BookSection < Library::Citation
  #attr_accessible :author, :year, :title, :editor, :book_title, :city, :publisher_id, :volume, :number_of_volumes, :series_volume, :chapter, :series_editor, :series_title, :pages, :edition, :isbn_or_issn, :doi, :keywords, :abstract, :url
  
  
  def self.custom_attributes
    [ :author, :year, :title, :editor, :book_title, :city, :publisher_id, :volume, :number_of_volumes, :series_volume, :chapter, :series_editor, :series_title, :pages, :edition, :isbn_or_issn, :doi, :keywords, :abstract, :url]
  end
end
