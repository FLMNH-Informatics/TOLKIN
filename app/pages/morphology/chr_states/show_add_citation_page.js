...
JooseModule('Morphology.ChrStates', function () {
  JooseClass('ShowAddCitationPage', {
    ...
    has: {
      ...
      title: {is: 'ro', init: 'Morphology Character State: Add Citation'},
      htmlLoader: { is: 'ro', init: function () { return $HtmlLoader({
        pathname: 'show_add_citation_project_morphology_character_chr_state_path'
      }, this)}}
    },
    methods: {
      ...
      onSubmit: function (event) {
        ...
        Event.delegate({
          '.citation_add': function (event) {
            ...
            var path   = window.location.pathname + '/chr_states/' + params["id"] + '/citation_add';
              ...
              new Ajax.Request(path, {
                ...
                onSuccess: function (transport) {
                  if (transport.responseJSON.msg.startsWith('Err')){
                    ...
                    $('chr_state_table_' + params["id"]).replace(transport.responseJSON.partial);
