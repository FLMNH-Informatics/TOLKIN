...
JooseModule('Morphology.Matrices', function () {
  JooseClass('EditPage', {
    ...
    has: {
      ...
      title:          { is: 'ro', init: 'Morphology Matrix : Edit' },
      ...
      htmlLoader:     { is: 'ro', init: function () { return $HtmlLoader({
        pathname: 'edit_project_morphology_matrix_path'
      }, this) } }
    },
    methods: {
      onClick: function (event) {
        ...
        Event.delegate({
          'input[type="button"][value="Save"]': function (event) {
            ...
            new Ajax.Request('/projects/' + params['project_id'] + '/morphology/matrices/' + params['id'] + '/',{
              method: 'put',
